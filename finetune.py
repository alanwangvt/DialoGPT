...
DATA_FILE = 'bit4444_dialogpt.csv'
MODULE_NAME = 'bit4444-small'
...
class Args():
    def __init__(self):
        ...
        self.seed = 42
        self.local_rank = -1   # -1 if there is only one node 
        self.fp16 = False
...
def main(df_trn, df_val):
    ...
    args.n_gpu = torch.cuda.device_count()   # added args.local_rank %
    args.device = device
    # torch.distributed.init_process_group(backend='NCCL', init_method='env://', world_size=args.local_rank, rank=args.local_rank)
