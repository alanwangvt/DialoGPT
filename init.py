...
app.config["SESSION_FILE_DIR"]= "/var/log"
...
#    app.run(debug=True, port=5000, ssl_context=('/etc/letsencrypt/live/office.scholars.bond/fullchain.pem', '/etc/letsencrypt/live/office.scholars.bond/privkey.pem'), host='office.scholars.bond')
